...
module Powerpoint
  class Presentation
    ...
    def add_fluvip_info_social_network_account_slide(title, image_path, provider_path, influencer_data, gender_data, ages_data, interests_data, countries_data, cities_data, top_followers_data, sn_image_path)
