...
require 'powerpoint/slide/fluvipSlide/text'
require 'powerpoint/slide/fluvipSlide/objective'
require 'powerpoint/slide/fluvipSlide/info_campaign'
require 'powerpoint/slide/fluvipSlide/totals_campaign'
require 'powerpoint/slide/fluvipSlide/info_social_network_account'
